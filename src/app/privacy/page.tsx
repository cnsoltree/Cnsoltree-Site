          ...
          <div className="mx-auto max-w-3xl">
            <div className="prose prose-gray max-w-none text-sm leading-relaxed text-gray-600 [&_h2]:mb-3 [&_h2]:mt-10 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-gray-900 [&_p]:mb-4 [&_ul]:mb-4 [&_ul]:space-y-1.5 [&_ul]:pl-5 [&_ul>li]:list-disc [&_ul>li]:text-gray-600">
              ...
              <p>
                ...
                to outside parties except as required to operate our website or comply with the law.
              </p>
              ...
              <p>
                Visitor comments may be checked through an automated spam detection service. No other
                personal data is transferred to external parties without your explicit consent.
              </p>
