        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-gray-400">
              Professional B2B manufacturer of low-voltage electrical
              protection products. Trusted by distributors and system
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li className="flex items-start gap-3 text-sm text-gray-400">
                ...
                No.123 Industrial Avenue, Zhejiang, China
              </li>
              <li className="flex items-center gap-3 text-sm text-gray-400">
                ...
                <a href="mailto:sales@cnsoltree.com" className="hover:text-white transition-colors">
                  sales@cnsoltree.com
                </a>
              </li>
              <li className="flex items-center gap-3 text-sm text-gray-400">
                ...
                <a href="tel:+8657112345678" className="hover:text-white transition-colors">
                  +86 571 1234 5678
                </a>
              </li>
              <li className="flex items-center gap-3 text-sm text-gray-400">
